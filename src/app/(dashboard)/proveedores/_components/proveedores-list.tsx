...
import { updateProveedor, deleteProveedor, type ProveedorConFacturas } from '@/lib/actions/proveedores'
  ...
  return (
    <div className="space-y-4">
      <input
        ...
        className="w-full max-w-sm h-9 px-3 text-sm border rounded-md bg-background outline-none focus:ring-2 focus:ring-ring"
      />
